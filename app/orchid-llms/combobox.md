<!-- Generated from content/docs/components/combobox.mdx. Do not edit. -->
...
import type { BadgeTone } from "@ui/displaying-data/badge";
...
function ComboboxFulfilmentExample() {
  ...
  return (
    <Combobox
      items={[...fulfilmentTypes]}
      multiple
      defaultValue={[...fulfilmentTypes]}
    >
          ...
          {(value: string[]) =>
            value.map((item) => (
              <ComboboxChip
                ...
                aria-label={item}
                tone={
                  fulfilmentBadgeTone[item as (typeof fulfilmentTypes)[number]]
                }
              >
                {item}
              </ComboboxChip>
          ...
          {(item: (typeof customers)[number]) => (
            ...
            >
              <span className="flex min-w-0 flex-col">
                <span>{item.name}</span>
                <span className="text-xs leading-normal text-oc-muted-foreground">
                  {item.email}
                </span>
              </span>
            </ComboboxItem>
      ...
      <div className="grid gap-8 md:grid-cols-2">
        <FieldGroup>
          <Field>
            ...
            <FieldDescription>
              Type a code or name to find a settlement currency.
            </FieldDescription>
          </Field>
          ...
          <Field>
            ...
            <FieldDescription>
              Search channels grouped by market.
            </FieldDescription>
          </Field>
          ...
          <Field>
            ...
            <FieldDescription>
              Add a product to an invoice, payment link, or POS sale.
            </FieldDescription>
          </Field>
        ...
        <FieldGroup>
          <Field>
            ...
            <FieldDescription>
              Badge color can be set per option.
            </FieldDescription>
          </Field>
          ...
          <Field>
            ...
            <ComboboxCustomersExample
              defaultValue={[customers[0], customers[1], customers[6]]}
            />
            <FieldDescription>
              Assign invoices or recurring plans to multiple customers.
            </FieldDescription>
          </Field>
          ...
          <Field>
            ...
            />
            <FieldDescription>
              Same Customer Data list, with checkbox selection.
            </FieldDescription>
          </Field>
          ...
          <Field>
            ...
            <FieldDescription>
              Search POS outlets grouped by country.
            </FieldDescription>
          </Field>
        </FieldGroup>
      </div>
