<!-- Generated from content/docs/components/sidebar.mdx. Do not edit. -->
...
- `childrenMode: 'sub-sidebar'` replaces the main navigation with a nested back panel (not the `SubSidebar` component). The back button calls `onSubSidebarClose`.
