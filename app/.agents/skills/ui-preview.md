...
5. Look for: blank/error page, missing AppShell/nav, unreadable type, clipped controls, horizontal overflow, empty table with no empty state, form with no submit, mobile-unusable nav (resize is optional; default shot is 1280×800).
