...
[Theming](/orchid-ui-guideline.md#theming) to import
...
Install the [Orchid theme tokens](/orchid-ui-guideline.md#theming), then add a component from
[Installation](/orchid-ui-guideline.md#installation).
...
Review [Components](/orchid-ui-guideline.md#components-json), then install the complete catalog with
`bunx --bun shadcn@latest add @orchid/all`. Do not install a subset. See
[Installation](/orchid-ui-guideline.md#installation) for init and add commands.
