<!-- Generated from content/docs/guides/installation-next.mdx. Do not edit. -->

# Next.js

Install Orchid in a new Next.js application.

Install Orchid in a new Next.js application using the supported `next` shadcn
template.
