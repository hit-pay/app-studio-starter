<!-- Generated from content/docs/guides/installation-tanstack-start.mdx. Do not edit. -->

# TanStack Start

Install Orchid in a new TanStack Start application.

Install Orchid in a new TanStack Start application using the supported `start`
shadcn template.

## Create the application

```bash
bunx --bun shadcn@latest init -t start
```
