...
import { InputGroup, InputGroupAddon } from '@/base-ui/form/input-group'
...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        'flex h-full w-auto min-w-0 max-w-full flex-col overflow-hidden rounded-xl bg-oc-background p-1 text-oc-foreground',
        className,
      )}
      {...props}
    />
