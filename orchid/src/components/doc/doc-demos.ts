...
export const BreadcrumbDemo = wrapped.BreadcrumbDemo;
...
export const CardDemo = wrapped.CardDemo;
...
export const ComboboxDemo = wrapped.ComboboxDemo;
...
export const DetailListDemo = wrapped.DetailListDemo;
...
export const ListItemDemo = wrapped.ListItemDemo;
...
export const StatCardDemo = wrapped.StatCardDemo;
export const SubSidebarDemo = wrapped.SubSidebarDemo;
export const SwitchDemo = wrapped.SwitchDemo;
export const TableDemo = wrapped.TableDemo;
