...
const COLOR_TOKENS: { token: string; utility: string; value: string; dark: string }[] = [
  ...
  { token: '--oc-primary', utility: 'bg-oc-primary', value: '#2465de', dark: '#ecece4' },
  { token: '--oc-primary-foreground', utility: 'text-oc-primary-foreground', value: '#fff', dark: '#14140f' },
  { token: '--oc-primary-300', utility: 'text-oc-primary-300', value: '#80acfe', dark: '#c8c8be' },
  ...
  { token: '--oc-destructive', utility: 'text-oc-destructive', value: '#dc3545', dark: '#c43542' },
  { token: '--oc-destructive-soft', utility: 'bg-oc-destructive-soft', value: '#f9e9e9', dark: '#2a1418' },
  { token: '--oc-destructive-border', utility: 'border-oc-destructive-border', value: '#e7a6a6', dark: '#6e3038' },
  ...
  { token: '--oc-info-soft', utility: 'bg-oc-info-soft', value: '#e5eeff', dark: '#2a2a24' },
  { token: '--oc-info-border', utility: 'border-oc-info-border', value: '#b3cdfe', dark: '#6e6e64' },
